...
export async function POST(req: NextRequest) {
  ...
  const { data: oohSummerVibes } = await sb.from('ooh_sites').insert([
    {
      ...
      lga: 'Lekki-Victoria Island Corridor',
    ...
    },
    {
      ...
      campaign_start: dAgo(14), campaign_end: dAgo(-76),
      lga: 'Lagos Mainland Mass Market',
    ...
    },
    {
      ...
      campaign_start: dAgo(14), campaign_end: dAgo(-76),
      lga: 'Abuja CBD Professional Zone',
  ...
  await sb.from('ooh_sites').insert([
    ...
    },
    {
      ...
      lga: 'South-South Oil Belt Professionals',
