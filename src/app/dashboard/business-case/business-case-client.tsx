...
const ESOV_POSTURE: Record<string, { label: string; color: string; bg: string; text: string }> = {
  growth:   { label: 'Growth Mode',     color: 'text-emerald-700', bg: 'bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200', text: 'You are outspending your market share weight. Binet & Field research shows positive ESOV predicts future market share growth — sustain this posture.' },
...
export function BusinessCaseClient({
  ...
  return (
    <div className="max-w-4xl space-y-10 pb-16">
      ...
      {esov != null && posture && (
        <section>
          <SectionHead icon={Target}>ESOV Analysis — Binet & Field Model</SectionHead>
        ...
        <section>
          ...
          <div className="rounded-2xl border bg-card p-5">
            ...
            <p className="text-[13px] leading-relaxed">
              ...
              {esov != null && esov > 0
                ? `${brand.name} is currently outinvesting its market share weight. Per the Binet & Field model, sustained positive ESOV over 12–18 months is the strongest single predictor of market share gain in packaged goods and QSR categories.`
      ...
      <div className="rounded-xl border bg-muted/20 p-5">
        ...
        <p className="text-[12px] text-muted-foreground leading-relaxed">
          Brand Health Index uses a 40/30/30 sentiment/SOV/survey weighting (Millward Brown BrandZ adaptation). ESOV analysis applies the Les Binet & Peter Field "Long and Short of It" model — positive ESOV consistently predicts market share growth in 12–18 month windows across FMCG and QSR categories. Channel portfolio classification uses BCG Matrix logic: Stars (high growth/high investment), Cash Cows (established/efficient), Question Marks (unproven/potential), Dogs (low efficiency).
          AI business case generated by BrandPulse using board-grade analysis tier.
        </p>
      </div>
    </div>
  )
