import {  TrendIcon as BarChart2, CircleDotIcon as Target, UsersIcon as Users, CreativeIcon as Palette, MusicIcon as Radio, PanelIcon as Tv, PrinterIcon as Newspaper, MapIcon as MapPin, AskIcon as Zap, StarIcon as Award, GlobeIcon as Globe, FilterIcon as Filter, StarIcon as Trophy } from '@/components/brand/icon'
...
export default function MethodologyPage() {
  return (
    <div className="max-w-4xl space-y-8 pb-16">
      ...
      <PageHeader
        {...PAGE_META['/dashboard/methodology']}
        title="Our Methodology"
        subtitle="How BrandGauge calculates every score, metric, and index, grounded in established measurement frameworks and adapted for the Nigerian and West African market."
        actions={<TourTrigger module="methodology" autoStart />}
      />
