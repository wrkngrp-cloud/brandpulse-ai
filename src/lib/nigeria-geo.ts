export const NIGERIA_STATES: { state: string; lgas: string[] }[] = [
  {
    state: 'Abia',
    lgas: ['Aba North', 'Aba South', 'Arochukwu', 'Bende', 'Ikwuano', 'Isiala Ngwa North', 'Isiala Ngwa South', 'Isuikwuato', 'Obi Ngwa', 'Ohafia', 'Osisioma', 'Umuahia North', 'Umuahia South'],
  },
  {
    state: 'Adamawa',
    lgas: ['Demsa', 'Fufure', 'Ganye', 'Girei', 'Gombi', 'Hong', 'Jada', 'Lamurde', 'Madagali', 'Maiha', 'Mubi North', 'Mubi South', 'Numan', 'Shelleng', 'Song', 'Yola North', 'Yola South'],
  },
  {
    state: 'Akwa Ibom',
  ...
  {
    state: 'Anambra',
    lgas: ['Anambra East', 'Anambra West', 'Anaocha', 'Awka North', 'Awka South', 'Ayamelum', 'Dunukofia', 'Ekwusigo', 'Idemili North', 'Idemili South', 'Ihiala', 'Njikoka', 'Nnewi North', 'Nnewi South', 'Ogbaru', 'Onitsha North', 'Onitsha South', 'Orumba North', 'Orumba South', 'Oyi'],
  },
  {
    state: 'Bauchi',
    lgas: ['Alkaleri', 'Bauchi', 'Bogoro', 'Dambam', 'Darazo', 'Dass', 'Gamawa', 'Ganjuwa', 'Giade', 'Itas/Gadau', 'Jama\'are', 'Katagum', 'Kirfi', 'Misau', 'Ningi', 'Shira', 'Tafawa Balewa', 'Toro', 'Warji', 'Zaki'],
  },
  {
    state: 'Bayelsa',
  ...
  {
    state: 'Cross River',
    lgas: ['Abi', 'Akamkpa', 'Akpabuyo', 'Bakassi', 'Bekwarra', 'Biase', 'Boki', 'Calabar Municipal', 'Calabar South', 'Etung', 'Ikom', 'Obanliku', 'Obubra', 'Obudu', 'Odukpani', 'Ogoja', 'Yakur', 'Yala'],
  },
  {
    state: 'Delta',
  ...
  {
    state: 'Kebbi',
    lgas: ['Aleiro', 'Arewa Dandi', 'Argungu', 'Augie', 'Bagudo', 'Birnin Kebbi', 'Bunza', 'Dandi', 'Fakai', 'Gwandu', 'Jega', 'Kalgo', 'Koko/Besse', 'Maiyama', 'Ngaski', 'Shanga', 'Suru', 'Wasagu/Danko', 'Yauri', 'Zuru'],
  },
  {
    state: 'Kogi',
  ...
  {
    state: 'Nasarawa',
    lgas: ['Akwanga', 'Awe', 'Doma', 'Karu', 'Keana', 'Keffi', 'Kokona', 'Lafia', 'Nassarawa', 'Nassarawa Egon', 'Obi', 'Toto', 'Wamba'],
  },
  {
    state: 'Niger',
